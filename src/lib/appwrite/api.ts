...
export async function savePost(userId: string, postId: string) {
  try {
    ...
    console.log('Creating document with userId:', userId, 'and postId:', postId);
    ...
    // Log the created document to check the response
    console.log('Document created:', updatedPost);
